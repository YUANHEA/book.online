<template>
    <div class="order-confirm clearfix">
        ...
        <modal title="新增确认" btnType="3" :showModal="showEditModal" @cancel="cancel" @surce="surce">
...
export default {
  ...
  methods: {
    ...
    // 提交订单
    submitOrder () {
      let { addressList, checkedIndex } = this
      let item = addressList[checkedIndex]
      if (!item) {
        this.$messages.error('请选择一个收货地址')
        return
      }
                ...
                .addr-list {
                    ...
                    .addr-add {
                        ...
                        .icon-add {
                            ...
                            height: 30px;
                            border-radius: 50%;
                            background: url("/static/imgs/icon-add.png") #e0e0e0
                                no-repeat center;
