            ...
            <div class="container clearfix">
                <div class="swiper">
                    <swiper :options="swiperOption">
                        ...
                        <swiper-slide>
                            <img src="/static/imgs/detail/phone-2.jpg" alt />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="/static/imgs/detail/phone-3.jpg" alt />
                        </swiper-slide>
                        <swiper-slide>
                            <img src="/static/imgs/detail/phone-4.jpg" alt />
                        </swiper-slide>
                        <!-- Optional controls -->
            ...
            .item-addr {
                ...
                .icon-loc {
                    ...
                    @include bgImg(
                        20px,
                        20px,
                        "/static/imgs/detail/icon-loc.png"
                    );
                }
                .addr {
                    color: #666666;
